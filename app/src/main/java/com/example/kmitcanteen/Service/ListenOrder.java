package com.example.kmitcanteen.Service;
...
import com.example.kmitcanteen.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        intent.putExtra("Rollno", request.getRollno()); //Kita perlu meletakan No Telp. Pengguna
